        ...
        <div className="profile">
          ...
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#78cc6d"
              multiText={["Software Developer", "Tech Enthusiast", "Lifelong Learner"]}
              multiTextDelay={1000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            <a
              className="link"
              href="https://www.linkedin.com/in/krishdeepakkapadia/"
              rel="noreferrer"
              target="_blank"
              aria-label="linkedin"
            >
            ...
            <a
              className="link"
              href="https://github.com/krishkapadia"
              rel="noreferrer"
              target="_blank"
              aria-label="github"
            >
          ...
          <div className="links">
            <a
              href="/assets/Krish_Deepak_Kapadia_Resume.pdf"
              className="link"
              rel="noreferrer"
              target="_blank"
              data-aos="fade-up"
            ...
            <Link to="/contact" className="link" data-aos="fade-up" data-aos-delay="100">
